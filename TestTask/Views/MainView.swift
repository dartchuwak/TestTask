                ...
                ScrollView {
                    VStack(spacing: 8) {
                        VStack(alignment: .leading) {
                            PageView(images: hotel.imageUrls)
                                .frame(height: 257)
                            ...
                            Text("\(hotel.minimalPrice.formattedWithSeparator) ₽ ")
...
#Preview {
    MainView()
        ...
        .environmentObject(Coordinator(viewModel: ViewModel(networkService: NetworkService())))
}
